...
export const UNION_TYPE_MATH_CONTEXT_SETTING_KEYS: {
  [k in keyof Partial<MathContextSettings>]: readonly string[];
} = {
...
export const UNION_TYPE_EXTRA_SETTING_KEYS: {
  [k in keyof Partial<ExtraSettings>]: readonly string[];
} = {
...
export type MathSettings =
  ...
  & TheoremCalloutPrivateFields;
export type ResolvedMathSettings =
