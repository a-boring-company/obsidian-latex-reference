...
export class LinkAutocomplete extends EditorSuggest<MathBlock> implements SuggestParent {
  ...
  setTriggers() {
    ...
    if (this.plugin.extraSettings.enableSuggest) {
      unsortedTriggers[this.plugin.extraSettings.triggerSuggest] = {
        range: 'vault',
        queryType: 'both',
      };
    }
    if (this.plugin.extraSettings.enableTheoremSuggest) {
      unsortedTriggers[this.plugin.extraSettings.triggerTheoremSuggest] = {
        range: 'vault',
        queryType: 'theorem',
      };
    }
    if (this.plugin.extraSettings.enableEquationSuggest) {
      unsortedTriggers[this.plugin.extraSettings.triggerEquationSuggest] = {
        range: 'vault',
        queryType: 'equation',
      };
    }
    if (this.plugin.extraSettings.enableSuggestRecentNotes) {
      unsortedTriggers[this.plugin.extraSettings.triggerSuggestRecentNotes] = {
        range: 'recent',
        queryType: 'both',
      };
    }
    if (this.plugin.extraSettings.enableTheoremSuggestRecentNotes) {
      unsortedTriggers[this.plugin.extraSettings.triggerTheoremSuggestRecentNotes] = {
        range: 'recent',
        queryType: 'theorem',
      };
    }
    if (this.plugin.extraSettings.enableEquationSuggestRecentNotes) {
      unsortedTriggers[this.plugin.extraSettings.triggerEquationSuggestRecentNotes] = {
        range: 'recent',
        queryType: 'equation',
      };
    }
    if (this.plugin.extraSettings.enableSuggestActiveNote) {
      unsortedTriggers[this.plugin.extraSettings.triggerSuggestActiveNote] = {
        range: 'active',
        queryType: 'both',
      };
    }
    if (this.plugin.extraSettings.enableTheoremSuggestActiveNote) {
      unsortedTriggers[this.plugin.extraSettings.triggerTheoremSuggestActiveNote] = {
        range: 'active',
        queryType: 'theorem',
      };
    }
    if (this.plugin.extraSettings.enableEquationSuggestActiveNote) {
      unsortedTriggers[this.plugin.extraSettings.triggerEquationSuggestActiveNote] = {
        range: 'active',
        queryType: 'equation',
      };
    }
    if (this.plugin.extraSettings.enableSuggestDataview) {
      unsortedTriggers[this.plugin.extraSettings.triggerSuggestDataview] = {
        range: 'dataview',
        queryType: 'both',
      };
    }
    if (this.plugin.extraSettings.enableTheoremSuggestDataview) {
      unsortedTriggers[this.plugin.extraSettings.triggerTheoremSuggestDataview] = {
        range: 'dataview',
        queryType: 'theorem',
      };
    }
    if (this.plugin.extraSettings.enableEquationSuggestDataview) {
      unsortedTriggers[this.plugin.extraSettings.triggerEquationSuggestDataview] = {
        range: 'dataview',
        queryType: 'equation',
      };
    }
